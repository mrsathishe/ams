...
import { FormField, FormSection, PasswordStrength } from "@/components/common/forms";
...
import { SignInSection, FormContainer, FormFieldGrid, SuccessMessage, LoadingSpinner } from "./styles";
import {
  PageContainer,
  ContentWrapper,
  FormWrapper,
    ...
    <>
      ...
      <PageContainer>
        <ContentWrapper>
          ...
          <SignInSection>
            {REGISTER_CONSTANTS.links.hasAccount}{" "}
            <Button
              variant="link"
              onClick={() => navigate(NAVIGATION_ROUTES.login)}
            >
              {REGISTER_CONSTANTS.buttons.signin}
            </Button>
          </SignInSection>
            <Card>
              <CardHeader>
